      ...
      <div className='w-[90%] lg:max-w-[60%] h-[600px] bg-white rounded-3xl flex overflow-hidden shadow-2xl'>
        ...
        <div className='w-full lg:w-[50%] flex flex-col items-center p-6 gap-5 justify-center'>
          ...
          <p className='text-gray-500 text-sm'>
            ...
            <span className='text-pink-500 cursor-pointer ml-1 hover:underline font-semibold' onClick={()=>navigate("/kids-signup")}>
              Kids Sign Up
            </span>
          </p>

          <p className='text-gray-500 text-sm'>
            Are you a kid logging in? 
            <span className='text-pink-500 cursor-pointer ml-1 hover:underline font-semibold' onClick={()=>navigate("/kids/login")}>
              Kids Login
            </span>
          </p>
        </div>
