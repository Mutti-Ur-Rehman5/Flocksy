        ...
        if(alreadyLiked){
            ...
            loop.likes.push(req.userId)
             if (loop.author._id != req.userId) {
                            ...
                            const populatedNotification = await Notification.findById(notification._id).populate("sender","name userName profileImage").populate("receiver","name userName profileImage").populate("loop")
